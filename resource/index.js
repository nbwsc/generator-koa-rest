...
module.exports = yeoman.generators.Base.extend({
    initializing: function() {
        ...
        this.log(
            "You called the KoaRest subgenerator with the argument " +
                this.name +
                "."
        );
    },
            ...
            [
                {
                    ...
                    name: "reviewed",
                    message:
                        "Have you peer reviewed your idea of the RESTful resource you are about to create.\n",
                    default: "n"
                }
            ],
            function(answers) {
                if (answers.reviewed.toLowerCase().indexOf("y") === -1) {
                    this.log(
                        "Please peer review your RESTful resource, write the spec in RAML and show it to your test engineers. It may save you some time ;D"
                    );
                } else {
                    done();
                }
